...
A lot of the information, notes and examples comes from these resources:
...
See Free Pascal User's guide (chapter 3 at the time of writing) for further details: https://www.freepascal.org/docs.html
